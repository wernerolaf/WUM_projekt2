...
##Podsumowanie
Przetestowaliśmy wiele różnych podejść i mimo że wartości indeksów nie wychodziły najlepsze to  dało się wizualnie oddzielić klasy od siebie. Ponadto wykazaliśmy zależności między psychiką dziecka, a zachowaniem na wycieczce oraz między zachowaniem dzieci, a tym co mówią o nich rodzice. Możliwe, że gdybyśmy mieli więcej wycieczek do analizy (mieliśmy tylko 69 opisanych wycieczek) to nasze statystyki byłyby bardziej pewne.
